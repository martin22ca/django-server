...
from gsalud.views.records_views import get_records_audit, add_record_to_user, update_records_to_user, save_record_to_user
from gsalud.views.records_views import remove_record_user,remove_all_assigned_records
...
urlpatterns = [
    ...
    path('updaterecord', update_records_to_user),
    path('saverecords', save_record_to_user),
    path('removeuserecord', remove_record_user),
    path('removealluserecords', remove_all_assigned_records),
]
