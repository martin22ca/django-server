...
from gsalud.utils.exel_upload import calculate_hash, safe_record_key, get_file_from_path
...
def manage_lots(file_path=''):
    try:
        print('Start Lot creation')
        df, config_data = get_file_from_path(file_path, config_id=5)
...
@background(schedule=0)
def manage_assignment(file_path):
    try:
        print('Start Assignment')
        df, config_data = get_file_from_path(file_path, config_id=4)
