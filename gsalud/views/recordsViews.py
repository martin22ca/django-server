...
def getUserRecords(request):
    try:
        ...
        base_query = """select ri.id_record,uxri.id as uxri_id,uxri.worked_on,ri.assigned,r.id_provider,business_name, rt.record_name ,ri.id_lot,l.id_user,p.coordinator_number,r.record_total,ri.date_assignment ,ri.date_entry_digital,ri.date_entry_physical,ri.seal_number,ri.observation 
    ...
    try:
        with transaction.atomic():
            ...
            for record_info in values_to_save:
                ...
                record_info_instance = uxri_instance.id_record_info
                record_info_instance['date_entry_digital'] = record_info['date_entry_digital']
                record_info_instance['date_entry_physical'] = record_info['date_entry_physical']
